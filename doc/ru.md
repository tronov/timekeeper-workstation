...
[fig_id]: ./fig1.png "This is where the title goes" height=45px width=120px

![Рисунок 1 — Образец наряда (лицевая сторона)][fig1]
[fig1]: fig1.png "Образец наряда (лицевая сторона)" height=45px width=120px
